...
using Natsurainko.FluentLauncher.ViewModels.Downloads.Maps;
using Natsurainko.FluentLauncher.Xaml.Converters;
using Nrk.FluentCore.Resources;

namespace Natsurainko.FluentLauncher.Views.Downloads.Maps;
    ...
    private void ContentFrame_Navigated(object sender, NavigationEventArgs e)
    {
        ...
        else
        {
            if (contentFrame.Content is ResourcePage)
            {
                ...
                breadcrumbBar.SetPath($"MapsDownload/{resourceName}");
            }
            else if (contentFrame.Content is ResourceDefaultPage)
            {
                breadcrumbBar.AddItem("MapsDownload");
            }
        }
    }
